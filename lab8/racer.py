...
background = pygame.image.load("C:\\Users\\admin\\Desktop\\pp2\\lab8\\elements\\street.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\admin\\Desktop\\pp2\\lab8\\elements\\coin.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("lab8/elements/car1.png")
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:\\Users\\admin\\Desktop\\pp2\\lab8\\elements\\mycar.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(p1, coinss):
        pygame.mixer.Sound('C:\\Users\\admin\\Desktop\\pp2\\lab8\\elements\\week8_lab_elements_coin_collect.wav').play()
        for entity in coinss:
            coin_score += 1
            entity.kill()
        c2 = Coin()
    ...
    if pygame.sprite.spritecollideany(p1, enemies):
        pygame.mixer.Sound('C:\\Users\\admin\\Desktop\\pp2\\lab8\\elements\\week8_lab_elements_crash.wav').play()
        time.sleep(0.5)
